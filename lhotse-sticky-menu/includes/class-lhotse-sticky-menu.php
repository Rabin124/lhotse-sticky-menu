...
class Lhotse_Sticky_Menu {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Lhotse_Sticky_Menu_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Lhotse_Sticky_Menu_Loader. Orchestrates the hooks of the plugin.
	 * - Lhotse_Sticky_Menu_i18n. Defines internationalization functionality.
	 * - Lhotse_Sticky_Menu_Admin. Defines all hooks for the admin area.
	 * - Lhotse_Sticky_Menu_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Lhotse_Sticky_Menu_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Lhotse_Sticky_Menu_Loader    Orchestrates the hooks of the plugin.
	 */
